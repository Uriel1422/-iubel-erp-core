...
const MOCK_CARDS = [
    ...
    {
        id: 'crd-002',
        cardholder: 'DEPARTAMENTO MARKETING',
        last4: '8811',
        brand: 'mastercard',
        type: 'Tarjeta Virtual (Suscripciones)',
        status: 'frozen',
        balance: 240.00,
        limit: 1000.00,
        exp: '05/26',
    ...
    {
        id: 'crd-003',
        cardholder: 'CARMEN JIMENEZ',
        last4: '7509',
        brand: 'ib-black',
        type: 'Cuenta Black Premium',
        status: 'active',
        balance: 125000.00,
        limit: 500000.00,
        exp: '09/29',
        cvv: '789',
        color: 'linear-gradient(135deg, #000000 0%, #1e1e1e 100%)',
        textColor: '#d4af37' // Gold text
    }
];

const MOCK_TRANSACTIONS = [
    { id: 1, cardId: 'crd-001', date: '10 Mar 2026', time: '14:30', merchant: 'Amazon Web Services', category: 'Software', amount: -450.00, status: 'completed' },
    { id: 2, cardId: 'crd-001', date: '09 Mar 2026', time: '09:15', merchant: 'Uber Eats', category: 'Alimentación', amount: -24.50, status: 'completed' },
    { id: 3, cardId: 'crd-003', date: '08 Mar 2026', time: '20:45', merchant: 'Restaurante El Laurel', category: 'Entretenimiento', amount: -3200.00, status: 'completed' },
    { id: 4, cardId: 'crd-002', date: '01 Mar 2026', time: '10:00', merchant: 'Google Ads', category: 'Marketing', amount: -150.00, status: 'declined', note: 'Tarjeta Congelada' },
    { id: 5, cardId: 'crd-001', date: '28 Feb 2026', time: '16:20', merchant: 'Apple Store', category: 'Equipos', amount: -1299.00, status: 'completed' },
];
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '1.5rem', height: '100%' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1rem' }}>
                    <div className="card glass layout-card" style={{ padding: '1.5rem' }}>
                        ...
                        <div style={{ fontSize: '2rem', fontWeight: 800 }}>{formatMoney(activeCard.balance)}</div>
                        <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginTop: '0.25rem' }}>Corte: 15 de cada mes</div>
                    </div>
                    <div className="card glass layout-card" style={{ padding: '1.5rem' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-muted)', marginBottom: '0.5rem' }}>
                            <ShieldCheck size={16} /> Límite de Crédito
                        </div>
                        <div style={{ fontSize: '1.5rem', fontWeight: 700, color: 'var(--text-main)' }}>{formatMoney(activeCard.limit)}</div>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.75rem', marginTop: '0.4rem', color: 'var(--text-muted)' }}>
                            ...
                            <span>Disponible: {formatMoney(activeCard.limit - activeCard.balance)}</span>
                        </div>
                    </div>
                    <div className="card glass layout-card" style={{ padding: '1.5rem', background: 'linear-gradient(135deg, #10b981 0%, #059669 100%)', color: 'white', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                        ...
                        <div style={{ fontSize: '1.8rem', fontWeight: 800 }}>{formatMoney(Math.max(activeCard.balance * 0.05, 500))}</div>
                        <button className="btn" style={{ background: 'white', color: '#059669', border: 'none', padding: '0.5rem', marginTop: '1rem', width: '100%', fontSize: '0.85rem' }}>
                            Pagar Ahora
                        </button>
                    </div>
                </div>
